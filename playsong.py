...
def buttonPressed(channel):
    whichlist=[([('C', 0.5), ('C', 0.5), ('G', 0.5), ('G', 0.5),
            ('A', 0.5), ('A', 0.5), ('G', 1),
            ...
            ('D', 0.5), ('D', 0.5), ('C', 1)]),
            ([("E",.25),("D",.25),("C",.5),("E",.25),
            ("D",.25),("C",.5),("C",0.1),("C",0.1),
            ("C",0.1),("C",0.1),("D",0.1),("D",0.1),
            ("D",0.1),("D",0.1),("E",.25),("D",.25),("C",.25)]),
            ([("E",0.5),("E",0.5),("F",0.5),("G",0.5),("G",0.5),("F",0.5),
            ("E",0.5),("D",0.5),("C",0.5),("C",0.5),
            ("D",0.5),("E",0.5),("E",1),("D",0.5),
            ("D",0.5),("E",0.5),("E",0.5),("F",0.5),
            ("G",0.5),("G",0.5),("F",0.5),("E",0.5),("D",0.5),
            ("C",0.5),("C",0.5),("D",0.5),("E",0.5),
            ("D",0.5),("C",0.5),("C",1)])]
            
    song=whichlist[songthis]

    #song2 = play([("E",.25),("D",.25),("C",.5),("E",.25),("D",.25),("C",.5),("C",0.1),("C",0.1),("C",0.1),("C",0.1),("D",0.1),("D",0.1),("D",0.1),("D",0.1),("E",.25),("D",.25),("C",.25)])
